...
#define LEADER_UWB_ID 0x00000650
#define LEADER_UWB_MSG LEADER_UWB_ID,8,1,1
...
public:
    ...
    void CAN_retrans(int id_origin,int msg_length,bool EFF,int CAN_channel,int* CANmsg_origin);
private:
